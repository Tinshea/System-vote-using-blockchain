...
//6.4
//rend la position où est censé se situer la cellule dans la table de hachage avec gestion des collisions avec probing linéaire
...
Key *compute_winner(CellProtected *decl, CellKey *candidates, CellKey *voters, int sizeC, int sizeV) {
  // decl est composé des déclarations vérifiées
  // On crée une table pour les électeurs et pour les candidats
