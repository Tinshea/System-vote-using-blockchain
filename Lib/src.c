...
//fonction maison, rend la longueur d'un tableau de long, pas très propre
int tablen (long* tab)
{
    int i = 0;
    while (tab[i]){
...
//fonction maison, pour faire un tri dans generate_random_data
...
//fonction maison pour connaitre l'appartenance d'un entier dans un tableau
