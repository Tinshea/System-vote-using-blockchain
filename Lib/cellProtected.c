 ...
 //5.6
 //alloue et initialise un chainon de liste chainée de déclarations
...
//fonction maison
//rend la longueur d'une liste chainée
...
void fraudverif(CellProtected ** cp){
...
//8.8
//ATTENTION pour free debut -> delete_list_pr(debut) || pour free fin : (fin) 
